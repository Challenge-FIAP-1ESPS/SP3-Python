...
def ouvir_medico():
    ...
    with mic as source: #Usado para abrir, usar e depois fechar automaticamente
        ...
        #A variavel armazena, puxamos a variavel recognizer, capitura o áudio do microfone
    ...
    try:
        ...
        return ""
    except sr.RequestError as e: #tratamento de erros, ocorre quando não foi possível acessar o serviço do google
